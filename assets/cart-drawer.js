...
(() => {
  ...
  class CartDrawer extends HTMLElement {
    connectedCallback() {
      ...
      this.shippingGoalLabel = this.querySelector('[data-cart-drawer-shipping-goal-label]');
    ...
    renderShippingProgress(cart) {
      ...
      if (this.shippingGoal) this.shippingGoal.textContent = unlocked ? "You've got it!" : this.formatMoney(remaining);
      if (this.shippingGoalLabel) this.shippingGoalLabel.textContent = unlocked ? 'Free shipping unlocked' : 'To go';
