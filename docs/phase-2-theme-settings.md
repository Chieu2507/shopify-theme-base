...
| type_body_size | range | 14–20, step 1px | 14 | `--font-body-md`; xs/sm/lg/xl/xxl = base × 5/7, 6/7, 8/7, 9/7, 10/7 |
...
- Token: snippets/css-variables.liquid.
- Existing SVG usage: sections/header.liquid và assets/icon-*.svg.
